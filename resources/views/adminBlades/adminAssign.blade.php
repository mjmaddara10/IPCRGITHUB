...
@section('navbar')
<!-- Main Navigation Bar -->
<nav class="navbar navbar-expand-sm navbar-light border-bottom position-fixed top-0 w-100"
    style="height: 55px; background-color: #ffffff; z-index: 1030;">
...
<div class="gold-gradient position-fixed top-0 w-100" style="margin-top: 55px; z-index: 1029;"></div>
@section('content')
    ...
    <div class="bg-white">
        ...
        <div class="card-header py-3 d-flex align-items-center nv-green">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h4 class="mb-0 text-white" style="font-family: 'Montserrat', sans-serif; font-weight: 600;">Assign
                        IPCR</h4>
        ...
        <div class="p-4">
            <div class="d-flex justify-content-between align-items-center mb-1">
                <div class="d-flex align-items-center" style="color: #03592c; font-weight: 500;">
                    <span>Select User:</span>
                    <select class="form-select ms-2" style="width: 250px; border: 2px solid #03592c;">
            ...
            <div class="row">
                <div class="col-12"
                    ...
                    <p class="justified-text">
                        I, JULIUS N. IGLESIAS, Administrative Officer IV (HRMO II)- Permanent of the PROVINCIAL HUMAN
                        RESOURCE MANAGEMENT
                        OFFICE, BENEFITS AND WELFARE DIVISION, commit to deliver and agree to be rated on the attainment
                        of
                    ...
                    <div class="row mt-3 align-items-center">
                        ...
                        <div class="col-md-4 d-flex align-items-center flex-nowrap">
                            <h6 class="mb-0 me-3 text-nowrap">Reviewed by:</h6>
                        ...
                        <div class="col-md-4 d-flex align-items-center flex-nowrap">
                            <h6 class="mb-0 me-3 text-nowrap"></h6>
                            <input type="text" class="form-control w-75" placeholder="Type here...">
                        </div>
                        <div class="col-md-4 d-flex align-items-center flex-nowrap">
                            <h6 class="mb-0 me-3 text-nowrap">Approved by:</h6>
                            <input type="text" class="form-control w-100" placeholder="Type here...">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table id="usersTable" class="table table-hover" style="width: 100%;">
                    <thead class="text-center">
                        <tr>
                            ...
                            <th style="color: #FFFFFF; background-color: #dd9f03;">Major Programs /Project/Activities
                            </th>
