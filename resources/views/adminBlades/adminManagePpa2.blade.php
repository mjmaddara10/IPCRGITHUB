    ...
    <div class="container-fluid mt-3">
        <div class="bg-white">
            ...
            <div class="p-4">
                <!-- Add PPA Button -->
                <!-- <div class="mb-3">
                    <button class="btn" data-bs-toggle="modal" data-bs-target="#addProgramModal" style= "color: #FFFFFF; background-color: #03592c;">
                        <i class="fas fa-plus" style= "color: #FFFFFF; -webkit-text-stroke: 1px white;"></i></i> Add Program
                    </button>
                </div> -->
                ...
                <div class="table-responsive">
                    <table id="ppaTable" class="table table-hover">
                        <thead class="text-center">
                            <tr>
                                <th class="border border-light" style="color: #FFFFFF; background-color: #dd9f03; width: 15%;">Major Programs/Project/Activities</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-left" style= "color: #FFFFFF; background-color: #03592c;" colspan="5">Sample Program Name</td>
                            ...
                            <tr>
                                ...
                                <td class="text-left ps-4" style= "color: #FFFFFF; background-color:rgb(1, 165, 80);" colspan="5">Sample Project Name</td>
                            ...
                            <tr>
                                @foreach($project->activities as $activity)
                                    ...
                                    <td class="text-left ps-5 border border-muted">{{ $program->name }}</td>
                                    <td class="text-left border border-muted"style="white-space: pre-wrap;">{{ $activity->successIndicator }}</td>
                                    <td class="text-left border border-muted"style="white-space: pre-wrap;">{{ $activity->quality }}</td>
                                    <td class="text-left border border-muted"style="white-space: pre-wrap;">{{ $activity->efficiency }}</td>
                                    <td class="text-left border border-muted"style="white-space: pre-wrap;">{{ $activity->timeliness }}</td>
