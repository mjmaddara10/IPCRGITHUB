        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <div class="d-flex gap-2">
                <button class="btn text-white mr-2"
                    style="background-color: #0d5cba; font-family: 'Montserrat', sans-serif;" data-bs-toggle="modal"
...
@endsection
<div class="container-fluid text-white p-3 d-flex flex-column flex-lg-row align-items-center justify-content-between"
    style="background-color: #03592c; font-family: Montserrat, sans-serif;">

    <!-- Welcome Message -->
    <h1 class="fw-bold text-white m-0" style="font-weight: 900;">Welcome, User</h1>

    <!-- Buttons Section -->
    <div class="d-flex flex-wrap gap-2 justify-content-center">
        <button class="btn text-white px-3"
    ...
    <table id="dynamicTable" class="table bg-transparent flex-grow-1 text-center"
        ...
        <tbody>
            <tr>
                ...
                <td class="wrap-text;" style="text-align: left; font-size: small;"></td>
                <td  class="wrap-text;" style="text-align: left; font-size: small;"></td>
                <td class="wrap-text" style="text-align: left; font-size: small;"></td>
                <td class="wrap-text" style="text-align: left; font-size: small;"></td>
                <td class="wrap-text" style="text-align: left; font-size: small;"></td>
