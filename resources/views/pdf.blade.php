    ...
    <body class="calibri">
        <main>
            ...
            <table style="fixed; width: 100%;" class="border">
                @if($employee->role === 'Staff' || $employee->role === 'Division Chief' || $employee->role === 'Assistant Department Head')
                    <tr class="small">
            ...
            <div>
                @if($employee->role === 'Staff' || $employee->role === 'Division Chief' || $employee->role === 'Assistant Department Head')
                    <table style="fixed; width: 100%; margin-bottom: 20px;" class="border">
                        <thead style="background-color:rgb(225, 225, 225);">
                            <tr class="smaller" style="text-align: center;">
                ...
                @elseif($employee->role === 'Department Head')
                    <table style="fixed; width: 100%; margin-bottom: 20px; table-layout: fixed;" class="border">                        
                        <thead style="background-color:rgb(225, 225, 225);">
                            <tr class="smaller" style="text-align: center;">
                            ...
                            <tr class="smaller" style="text-align: center;">
                                <td class="bold border" style="width:12%;">QUALITY</td>
                                <td class="bold border" style="width:12%;">EFFICIENCY</td>
                                <td class="bold border" style="width:12%;">TIMELINESS</td>
                            </tr>
                        </thead>
