...
<nav class="navbar navbar-expand-sm navbar-light border-bottom"
    ...
    <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <button class="btn btn-success btn-login" type="button" data-bs-toggle="modal" data-bs-target="#loginModal">
        ...
        <div class="modal-content border-0 shadow">
            ...
            <div class="modal-body" style="background-color: #f8f9fa;">
                ...
                <form class="p-2" action="{{ route('userLogin') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                        <label for="username" class="form-label fw-bold mb-2 default-text">
                    ...
                    <div class="mb-4">
                        <label for="password" class="form-label fw-bold text-dark mb-2 default-text">
